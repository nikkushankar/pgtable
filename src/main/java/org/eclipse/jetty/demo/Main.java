...
import io.funxion.DataTable;
import io.funxion.PGDataSource;
...
public class Main
{
    ...
    public void start() throws Exception
    {
        ...
        servletContextHandler.addServlet(DataTable.class, "/data");
        //servletContextHandler.addServlet(RestData.class, "/dataapi");
